...
const Menu = () => {
  ...
  const weddingText = {
    ...
    bn: {
      ...
      stall: ["চা, কফি", "ফুচকা, পাপড়ি চাট", "মোমো", "মিক্সড ফ্রুট", "ফিশ বল, পনির চীজ বল", "বেবি কর্ন", "রেশমি কাবাব", "রেড কাবাব", "চিকেন ললিপপ", "জিলিপি রাবড়ি", "মাখা সন্দেশ", "গোলাপ জামুন", "মিক্সড ফ্রুট জুস পার্লার", "মকটেল কাউন্টার", "আইসক্রিম পার্লার", "পান"],
